    ...
    <div className="container py-8 md:py-16 max-w-3xl mx-auto space-y-8">
      ...
      <div className="space-y-8 text-sm text-[var(--color-laburante-text-secondary)] leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p>Las cuentas Empresa pueden comenzar con la opción Gratis, que incluye búsqueda, perfiles, proyectos y propuestas de selección. Si una empresa quiere conocer otras posibilidades, puede solicitar que la contactemos para coordinar una entrevista y conversar la activación. No se realiza ningún cobro desde el formulario de registro sin autorización.</p>
        </section>
