    ...
    <div className="container py-12 md:py-20 max-w-md mx-auto">
      <div className="rounded-3xl border border-[var(--color-laburante-border)] bg-[var(--color-laburante-surface)] p-6 sm:p-8 space-y-6 shadow-xs">
        ...
        <button
          ...
          className="w-full py-3 px-4 rounded-xl border border-[var(--color-laburante-border)] bg-white hover:bg-gray-50 text-[var(--color-laburante-text)] font-heading font-semibold text-sm transition-all hover:shadow-sm disabled:opacity-50 flex items-center justify-center gap-3"
        >
